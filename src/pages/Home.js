              ...
              <div className="col-md-8 col-md-offset-2 gtco-heading text-center">
                ...
                <p>
                  <a
                    ...
                    className="btn btn-special popup-vimeo"
                  >
                    Watch The Video
                  </a>
                </p>
            ...
            <div className="row row-pb-md">
              <div className="col-md-4 col-sm-4 service-wrap">
                <div className="service">
                  <h3>
                    <i className="ti-pie-chart"></i> Marketing
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Consectetur voluptatibus nesciunt, est alias deleniti ipsum
                    fuga ullam maxime repudiandae neque, ad. Maiores quis atque,
                    culpa rem inventore vero amet praesentium, quam sint, magnam
              ...
              <div className="col-md-4 col-sm-4 service-wrap">
                <div className="service animate-change">
                  <h3>
                    <i className="ti-ruler-pencil"></i> Design
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Minima quidem quae, assumenda dolores ad pariatur! Deleniti
                    debitis, voluptatem! Omnis enim magnam perspiciatis, natus.
                    Ipsum distinctio, voluptatibus vero laboriosam sequi!
                    Officia fuga quam eveniet quo similique!
                  </p>
                </div>
              </div>
              <div className="col-md-4 col-sm-4 service-wrap">
                <div className="service">
                  <h3>
                    <i className="ti-settings"></i> Development
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Dicta aperiam, maiores officia alias accusantium fugiat,
                    doloremque voluptas, voluptatem dolore vel animi praesentium
                    saepe unde consequuntur, eum asperiores odit aliquam error
                    nulla impedit repellendus. Nesciunt, delectus.
                  </p>
                </div>
              </div>
                ...
                <div className="gtco-testimony gtco-left">
                  ...
                  <blockquote>
                    <p>
                      ...
                      gimmicks that have to be explained.”
                ...
                <div className="gtco-testimony gtco-left">
                  ...
                  <blockquote>
                    <p>
                      ...
                      the potency of your craft, where you choose to dole it out
